    ...
    <div style="margin-top: 10px">
      <el-table
        ...
        <el-table-column
          ...
          <el-button size="small" @click="deleteHandler(scope.row)">删除</el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <table>
        <tr>
          ...
          <td><el-input v-model="updateJl.name" size="small" style="margin-left: 6px"></el-input></td>
        </tr>
        <tr>
...
export default {
  ...
  methods:{
    ...
    deleteHandler(data){
      this.$confirm('次操作将永久删除['+data.name+']职称,是否继续？','提示', {
        confirmButtonText: '确定',
        cancelButtonText: '却笑',
        type: 'warning'
      }).then(() =>{
